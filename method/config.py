...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--exp_id", type=str, default='demo', help="id of this run, required at training")
        ...
        # post processing
        self.parser.add_argument("--model_name", type=str, default='MS-SL_Net_pp')
        ...
        self.parser.add_argument('--length_pos', action="store_true")
        self.parser.add_argument('--cluster', action="store_true")
        self.parser.add_argument('--cluster_num', type=int, default=32)
